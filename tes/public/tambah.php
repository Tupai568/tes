...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link active" href="tambah.php">Tambah_Produk</a>
          </div>
        </div>
      </div>
    </nav>
    ...
    <section>
      <span><?= notif() ?></span>
      <h1 class="text-center mb-3">Tambah</h1>
      ...
      <form action="" method="post" class="bg-dark"> 
          ...
          <button type="submit" name="Tproduk" class="btn btn-primary">Submit</button>
      </form>
      </div>
    </section>
